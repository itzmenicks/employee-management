...
// Mark read if viewing notifications
...
<head>
    ...
    <style>
        ...
        .notif-icon { display:inline-block; margin-right:6px; }
    </style>
</head>
<body>
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-label">Payroll & Time</div>
        <a href="salary.php" class="nav-item <?= $activePage==='salary'?'active':'' ?>">
        ...
        <a href="leaves.php" class="nav-item <?= $activePage==='leaves'?'active':'' ?>">
            <span class="icon">🏖️</span> Leave Approvals
        </a>
...
<main class="main">
    <div class="topbar">
        ...
        <div class="topbar-actions">
            <?php if ($activePage === 'employees'): ?>
                <a href="employee_form.php" class="btn btn-primary">+ Add Employee</a>
            <?php elseif ($activePage === 'departments'): ?>
                <a href="department_form.php" class="btn btn-primary">+ Add Department</a>
            <?php elseif ($activePage === 'salary'): ?>
                <a href="salary_form.php" class="btn btn-primary">+ Add Salary Record</a>
            ...
            <div class="notif-bell" id="notifBell" onclick="toggleNotif()">
                ...
                <div class="notif-dropdown" id="notifDropdown">
                    ...
                    <div class="notif-footer">
                        <a href="?mark_read=1" style="font-size:12px;color:var(--muted);text-decoration:none">Clear all notifications</a>
                    </div>
                </div>
            </div>
        </div>
